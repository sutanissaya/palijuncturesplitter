...
"""
Simply type or paste some Pāḷi text (there is a couple of resources below) you would like to juncture-split into the box then click anywhere outside the box (or press <em>Ctrl</em>+<em>Enter</em>) to have the app instantaneously render the result.\n
