...
def animation_demo() -> None:
    ...
    m_ṃ_semicolon = M_Ṃ_qmark.replace('m'+';','ṃ'+';')
...
#CONTINUE HERE
    ...
    sepa_emdash = sepa_qmark.replace(sepa+"—","—"+sepa)
    ...
    a_sepa_emdash = u_sepa_qmark.replace("a"+"—", "a"+"—"+sepa)
    ...
    undo_a_sepa_emdash = undo_u_sepa_qmark.replace("a"+"—"+sepa, "a"+"—")
    ...
    **Split text:**
    ...
    emdash_sepa = fix_qmark_sepa.replace("—", "—"+sepa)
