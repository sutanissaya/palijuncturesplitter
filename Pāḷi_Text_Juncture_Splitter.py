...
def animation_demo() -> None:
    ...
    m_ṃ_lbreak = M_Ṃ_semdash.replace('m'+'\n','ṃ'+'\n')
...
#CONTINUE HERE
    ...
    sepa_scolon = sepa_semdash.replace(sepa+";",";"+sepa)
    ...
    a_sepa_scolon = u_sepa_semdash.replace("a"+";", "a"+";"+sepa)
    ...
    undo_a_sepa_scolon = undo_u_sepa_semdash.replace("a"+";"+sepa, "a"+";")
