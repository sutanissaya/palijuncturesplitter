...
st.markdown('<p style='text-align: center;'>• <a href="https://tipitaka.app/"><strong>Chaṭṭha Saṅgāyanā Tipiṭaka</strong></a>, Vipassana Research Institute (VRI), 1956.</p>', unsafe_allow_html=True)
st.markdown('<p style='text-align: center;'>• <a href="https://tipitaka.app/"><strong>Tipiṭaka—the Three Baskets of the Buddhist Canon</strong></a>, SuttaCentral.</p>', unsafe_allow_html=True)
st.markdown('<p style='text-align: center;'>• <a href="https://bhikkhu-manual.github.io/essential-chants.html"><strong>Bhikkhu Manual: Essential Chants</strong></a>, Amaravati Publications, 2020.</p>', unsafe_allow_html=True)
st.divider()
