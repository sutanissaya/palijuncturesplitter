...
def animation_demo() -> None:
    ...
    # Convert m to ṃ when followed by a space " ", a comma ",", a period ".", a question mark ".", an exclamation mark "!", a semi-colon";", a colon ":", an em dash "—", an en dahs "–", or a line break / enter (char(10) or \n)
    ...
    m_ṃ_endash = M_Ṃ_emdash.replace('m'+'–','ṃ'+'–')
    M_Ṃ_endash = m_ṃ_endash.replace('M'+'–','Ṃ'+'–')
    m_ṃ_lbreak = M_Ṃ_endash.replace('m'+'\n','ṃ'+'\n')
...
#CONTINUE HERE
    ...
    sepa_endash = sepa_emdash.replace(sepa+"–","–"+sepa)
    sepa_scolon = sepa_endash.replace(sepa+";",";"+sepa)
    ...
    a_sepa_endash = u_sepa_emdash.replace("a"+"–", "a"+"–"+sepa)
    i_sepa_endash = a_sepa_endash.replace("i"+"–", "i"+"–"+sepa)
    u_sepa_endash = i_sepa_endash.replace("u"+"–", "u"+"–"+sepa)
    a_sepa_scolon = u_sepa_endash.replace("a"+";", "a"+";"+sepa)
    ...
    undo_a_sepa_endash = undo_u_sepa_emdash.replace("a"+"–"+sepa, "a"+"–")
    undo_i_sepa_endash = undo_a_sepa_endash.replace("i"+"–"+sepa, "i"+"–")
    undo_u_sepa_endash = undo_i_sepa_endash.replace("u"+"–"+sepa, "u"+"–")
    undo_a_sepa_scolon = undo_u_sepa_endash.replace("a"+";"+sepa, "a"+";")
    ...
    **Split text:**
    ...
    endash_sepa = fix_emdash_sepa.replace("–", "–"+sepa)
    fix_endash_sepa = endash_sepa.replace("–"+sepa+sepa+sepa, "–"+sepa+sepa)
    scolon_sepa = fix_endash_sepa.replace(";", ";"+sepa)
