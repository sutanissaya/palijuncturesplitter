...
st.markdown('<p>• <a href="https://tipitaka.app/"><strong>Tipiṭaka—the Three Baskets of the Buddhist Canon</strong></a>, SuttaCentral.</p>', unsafe_allow_html=True)
